...
public class LoginController {
    ...
    public ModelAndView createNewUser(@Valid User user, BindingResult bindingResult) {
        ModelAndView modelAndView = new ModelAndView();
        User userExists = ((UserService) serviceFactory.getService(ApplicationConstants.USER_SERVICE)).findUserByEmail(user.getEmail());
        if (userExists != null) {
            bindingResult
        ...
        if (bindingResult.hasErrors()) {
        	...
        	((UserService) serviceFactory.getService(ApplicationConstants.USER_SERVICE)).saveUser(user);
